...
export const Footer = () => {
  ...
  return (
    <Stack sx={{backgroundColor:"black",paddingTop:"3rem",paddingLeft:is700?"1rem":"3rem",paddingRight:is700?"1rem":"3rem",paddingBottom:"1.5rem",rowGap:"5rem",color:theme.palette.primary.light ,justifyContent:"space-around"}}>
            ...
            <Stack flexDirection={'row'} rowGap={'1rem'} justifyContent={is700?"":'space-around'} flexWrap={'wrap'}>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={labelStyles}>Jhansi ,Uttar Pradesh</Typography>
                    <Typography sx={labelStyles}>Sastify@gmail.com</Typography>
                    <Typography sx={labelStyles}>9999-9999-9999</Typography>
                </Stack>
            ...
            <Stack alignSelf={"center"}>
                <Typography color={'GrayText'}>&copy; Sastify {new Date().getFullYear()}. All right reserved</Typography>
            </Stack>
