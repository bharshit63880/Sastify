...
export const Checkout = () => {
  ...
  return (
    ...
    <Stack flexDirection={'row'} p={2} rowGap={10} justifyContent={'center'} flexWrap={'wrap'} mb={'5rem'} mt={2} columnGap={4} alignItems={'flex-start'}>
          ...
          maxWidth: 600,
            ...
            <Stack rowGap={3}>
                    ...
                    <Stack rowGap={2}>
                        ...
                        <Stack flexDirection={'row'} justifyContent={'flex-start'} alignItems={'center'}>
                            <Radio value={selectedPaymentMethod} name='paymentMethod' checked={selectedPaymentMethod==='ONLINE'} onChange={()=>setSelectedPaymentMethod('ONLINE')}/>
                            <Typography>Card/UPI</Typography>
                        </Stack>
        ...
        {/* right box */}
        <Stack  width={is900?'100%':'auto'} alignItems={is900?'flex-start':''} sx={{
          background: "rgba(255,255,255,0.85)",
          borderRadius: 4,
          boxShadow: "0 4px 32px 0 rgba(107,70,193,0.10)",
          p: is480 ? 1 : 4,
          minWidth: is900 ? "100%" : 350,
        }}>
